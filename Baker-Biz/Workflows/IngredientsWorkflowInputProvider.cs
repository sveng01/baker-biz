...
namespace BakerBiz.Workflows
{
    ...
    {
        IList<Tuple<IRecipe, int>> GetMenuItemQuantities(RecipeDataAccess dataAccess);
    }

    public class IngredientsWorkflowInputProvider : IIngredientsWorkflowInputProvider
    {
        public IList<Tuple<IRecipe, int>> GetMenuItemQuantities(RecipeDataAccess dataAccess)
        {
